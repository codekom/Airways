    ...
    <body>
        ...
        <div class="mydiv3">
          <div class="mydiv">
              <table align="center">
                  <tr>
                     <td colspan="2"><b>Forgot Password</b></td>
                 </tr>
                  <html:form action="forgotPServ" method="post">
                 <tr>
                      <td><font color="white"><b>Enter username</b></font></td>
                 ...
                 <tr>
                     <td colspan="4"><a href="home.jsp" title="Back to home page">
