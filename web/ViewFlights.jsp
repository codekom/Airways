...
<html>
    ...
    <body>
        ...
        <div class="mydiv3">
          <div class="mydiv">
              <font color="white" size="40px" style="padding-left:500px">FLIGHT DETAILS</font>
              <table align="center">
	 ...
	 <tr>
                 ...
                 <td><c:out value="${d.fromloc}"/></td>
                 <td><c:out value="${d.toloc}"/></td>
                 <td><a href="updateFlights.jsp?msg2=${d.fid}">Update</a></td>
         </tr>
	 </c:forEach>
         <tr>
